...
class WyvernTraceLog(models.Model):
    ...
    def get_first_name(self):
        return (
            self.wyvern_first_name
            if self.wyvern_first_name
            else self.wyvern_user.first_name
        )

    def get_last_name(self):
        return (
            self.wyvern_last_name
            if self.wyvern_last_name
            else self.wyvern_user.last_name
        )

    def get_phone_number(self):
        return (
            self.wyvern_phone_number
            if self.wyvern_phone_number
            else self.wyvern_user.phone
        )

    def get_resident_address(self):
        return (
            self.wyvern_resident_address
            if self.wyvern_resident_address
            else self.wyvern_user.address
        )
